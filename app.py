...
# pygame loads - so it has to be imported before pygame is used anywhere.
from agent_logic import DashboardBackend
...
if __name__ == '__main__':
    ...
    # CPU/GPU work), so it happens at startup, where a printed message
